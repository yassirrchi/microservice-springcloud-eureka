...
public class Microservicepart3Application {
    ...
    CommandLineRunner init(CustomerRepository customerRepository, RepositoryRestConfiguration restConfiguration){
        ...
        return args -> {
            customerRepository.save(new Customer(null,"Yassir Rchi","yassirrchi@email.com"));
            customerRepository.save(new Customer(null,"Mohammed El Youssefi","medyousfi@email.com"));
